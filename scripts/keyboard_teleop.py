...
def main():
    ...
    max_velocity = 1.0 #rospy.get_param("~speed", 2.0)
    max_steering_angle = 0.34 #rospy.get_param("~max_steering_angle", 0.34)

    state_pub = rospy.Publisher("/drive", AckermannDriveStamped, queue_size=1)
